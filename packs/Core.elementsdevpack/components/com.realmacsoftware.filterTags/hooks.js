...
const advancedClasses = (rw) => {
  ...
  const {
    ...
    placeholder,
    placeholderColor
  } = rw.props, filter = globalFilter(rw), {
    globalBgImageFetchPriorityEnabled,
    globalBgImageFetchPriorityLinkElement,
    globalBgImageFetchPriorityLinkElementEnd
    ...
    tag: classnames([
      ...
      globalEffects(rw, { active: !0 }),
      globalFilters(rw, { active: !0 }),
      globalTransforms(rw, { active: !0 }),
      globalBackground(rw, { active: !0 }),
      globalBorders(rw, { active: !0 }),
      globalButtonFontAndTextStyles(rw, { active: !0 }),
      placeholderColor
    ]).toString()
  }, tagOptions = {
