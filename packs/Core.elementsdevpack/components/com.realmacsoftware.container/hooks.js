...
const overlay = (rw) => {
  ...
  const {
    ...
    contentGap,
    globalControlTypeOverlay
  } = rw.props, { mode } = rw.project, { id } = rw.node, { tags } = rw.collections, dataTags = (tags == null ? void 0 : tags.map((tag) => tag.title).join(",")) || "", link = globalLink(rw), filter = globalFilter(rw), {
    globalBgImageFetchPriorityEnabled,
    globalBgImageFetchPriorityLinkElement,
    globalBgImageFetchPriorityLinkElementEnd
  } = globalBgImageFetchPriority(rw), bgVideo2 = globalBgType == "video" && globalBgVideo ? {
    ...
    wrapper: classnames([
      ...
      globalEffectsApplyTo === "everything" && globalEffects(rw, { isContainer: !0 }),
      globalTransformsApplyTo === "everything" && globalTransforms(rw, { isContainer: !0 }),
      globalFiltersApplyTo === "everything" && globalFilters(rw, { isContainer: !0 }),
    ...
    background: classnames([
      "z-0 transform-gpu",
      globalTransitions(rw),
      globalBorders(rw, { isContainer: !0 }),
      globalEffectsApplyTo === "background" && globalEffects(rw, { isContainer: !0 }),
      globalTransformsApplyTo === "background" && globalTransforms(rw, { isContainer: !0 }),
      globalFiltersApplyTo === "background" && globalFilters(rw, { isContainer: !0 }),
      globalBackground(rw, { peer: !0 }),
      "overflow-hidden"
    ]).toString(),
    content: classnames([
      "relative z-30 flex flex-col peer",
      globalTransitions(rw),
      globalEffectsApplyTo === "content" && globalEffects(rw, { isContainer: !0 }),
      globalTransformsApplyTo === "content" && globalTransforms(rw, { isContainer: !0 }),
      globalFiltersApplyTo === "content" && globalFilters(rw, { isContainer: !0 }),
    ...
    overlay: `relative z-20 ${globalControlTypeBorders != "none" && globalBordersRadius} ${globalTransitions(rw)} ${globalOverlay(rw, { isContainer: !0 })}`
  };
  rw.setRootElement({
