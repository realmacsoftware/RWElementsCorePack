...
const advancedClasses = (rw) => {
  ...
  } = rw.props, { mode } = rw.project, { tracks } = rw.collections, { sharedAssetPath } = rw.component, firstTrack = (tracks == null ? void 0 : tracks[0]) || {
  ...
  }, hasMultipleTracks = (tracks == null ? void 0 : tracks.length) > 1, classes = {
    wrapper: classnames([
      "text-white",
      advancedClasses(rw),
      globalLayout(rw),
