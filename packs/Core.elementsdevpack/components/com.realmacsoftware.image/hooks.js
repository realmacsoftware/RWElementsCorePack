...
const advancedClasses = (rw) => {
  ...
  rw.setRootElement({
    ...
    alt: imageAlt,
    classes,
    imageWidth: isResourceImage ? image == null ? void 0 : image.width : imageIntrinsicWidth,
    imageHeight: isResourceImage ? image == null ? void 0 : image.height : imageIntrinsicHeight,
    assetPath,
    sharedAssetPath,
