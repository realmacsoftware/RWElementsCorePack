...
const advancedClasses = (rw) => {
  ...
  const {
    ...
    modalAutoOpen,
    modalAutoOpenTime
  } = rw.props, { mode } = rw.project, { id } = rw.node, transitionAttributes = getAlpineTransitionAttributesMobile(modalTransitionStyle), classes = {
  ...
  }, openOnExitIntent = modalAutoOpen === "exitIntent", autoOpen = modalAutoOpen === "delay" || modalAutoOpen === "onload", autoOpenTime = modalAutoOpen === "delay" ? modalAutoOpenTime * 1e3 : 0;
  rw.setRootElement({
    as: "div",
